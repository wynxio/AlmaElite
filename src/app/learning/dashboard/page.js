...
export default function Dashboard() {
 ...
 <div className="col-md-6">
              <div className="card shadow-sm h-100">
                <div className="card-body d-flex flex-column justify-content-between">
                  <div>
                    <h5 className="card-title">CSS Missing Class Part 6 Recording</h5>
                    <p className="card-text mt-5">
                      Recording Missed for Mercury Batch. This is the recording from Jupitor Batch
                    </p>
                  </div>
                  <Link href="/learning/csspart6" className="btn btn-success mt-5">
                     CSS Part 6 Recording  
                  </Link>
                </div>
              </div>
            </div>
